...
- (void)notifyProgressChange
{
    ...
    if (self.labelTextBlock) {
        ...
        float percentageCompleted = _countTotal?_progressCounter:((100.0f / self.progressTotal) * self.progressCounter);
        text = percentageCompleted?[NSString stringWithFormat:@"%.0f", percentageCompleted]:nil;
    }

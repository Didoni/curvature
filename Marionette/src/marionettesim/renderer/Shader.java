...
public class Shader {
    ...
    void changeGLStatus(GL2 gl, Renderer r, Simulation s, MeshEntity e){
        r.enableBlend(gl, false);
        r.enableCullFace(gl,! (e.getMesh().equals( Resources.MESH_CUSTOM) || e.getMesh().equals( Resources.MESH_QUAD)) );
    ...
    public static String getSourceCode(String fileName){
        InputStream is = Shader.class.getResourceAsStream("/marionettesim/resources/" + fileName);
        try {

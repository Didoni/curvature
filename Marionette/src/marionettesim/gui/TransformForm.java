...
import marionettesim.utils.TextFrame;
...
public class TransformForm extends javax.swing.JFrame { 
    ...
    public static void editTransform(Transform t, Component c){
        TransformForm tf = new TransformForm(t);
    ...
    public TransformForm(JTextField targetField) {
        this.targetField = targetField;
        initComponents();
        objectToGui();
    }
    
    public TransformForm(Transform targetTransform) {
    ...
    private void viewMatrixButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewMatrixButtonActionPerformed
        ...
        targetTransform.copyToMatrix(matrix);
